...
object.Bazuka Hub = instance.new("ScreenGui", {
    Name = "Mo Mo Be";
    Parent = game.CoreGui;
...
local function wl(key)
    ...
    if sign_match == decode_response.sign then
        ...
        local Window =
            Fluent:CreateWindow(
            {
                Title = "Bazuka Hub Update 20",
                SubTitle = "Dev By Bazuka",
                TabWidth = 160,
        ...
        function Window:NewTab(mmb)
            ...
            function newmm:NewParagraph(cf)
                local paragraphnew
                newTitle = cf.Title or "Bazuka Hub"
                ...
                function paragraphnew:Set(cf2)
                    newTitle = cf2.Title or "Bazuka Hub"
        ...
        function SaveSettings2()
            ...
            writefile("Bazuka Hub/" .. SaveFileName2, HttpService:JSONEncode(Settings2))
        end
        ...
        function ReadSetting2()
            local s, e =
                ...
                function()
                    ...
                    return HttpService:JSONDecode(readfile("Bazuka Hub/" .. SaveFileName2))
                end
            )
            if s then
                return e
